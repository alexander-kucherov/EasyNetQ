...
public static class AutoSubscriberExtensions
{
    ...
    public static IAsyncDisposable Subscribe(this AutoSubscriber autoSubscriber, Assembly[] assemblies, CancellationToken cancellationToken = default)
    {
    ...
    public static IAsyncDisposable Subscribe(this AutoSubscriber autoSubscriber, Type[] consumerTypes, CancellationToken cancellationToken = default)
    {
